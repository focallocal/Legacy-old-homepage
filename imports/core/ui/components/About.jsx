    ...
    return (
      <section id="about" className="content-section">
        <div className="container">
          ...
          <p>
            <span>Focallocal is a way of living - and also an open, welcoming community made up of thousands of positive people, together targeting the root causes of any, and all societal issues<br></span>
